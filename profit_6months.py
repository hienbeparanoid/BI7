...
data = {'Month': ['11', '12', '1', '2', '3', '4'],
        'Profit': [136563.9985, 129650.7390, 108781.5305, 95879.8355, 110637.6290, 172003.4125]}
df = pd.DataFrame(data)

#plot the graph
plt.style.use('seaborn-whitegrid')
plt.figure(figsize=(10,6))
plt.bar(df['Month'],df['Profit'], label='Cost',color='#F09B59')
plt.xlabel('Month', fontsize=10, fontweight='bold')
plt.ylabel('Profit', fontsize=10, fontweight='bold')
plt.title('Profit by month', fontsize=16, fontweight='bold')
